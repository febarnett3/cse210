    ...
    static void Main(string[] args)
{
    ...
    static void DisplayMenu()
    {
        ...
        Console.WriteLine("4. Save activity statistics");
        Console.WriteLine("5. Load activity statistics");
    ...
    static void StartBreathingActivity(ActivityStatisticsManager statisticsManager)
    {
        ...
        statisticsManager.AddActivity(breathingActivity);
    }
    ...
    static void StartReflectingActivity(ActivityStatisticsManager statisticsManager)
    {
        ...
        statisticsManager.AddActivity(reflectingActivity);
    }
    ...
    static void StartListingActivity(ActivityStatisticsManager statisticsManager)
    {
        ...
        statisticsManager.AddActivity(listingActivity);
    }


    // static void LoadActivityStatistics()
    // {
    //     try
    //     {
    //         Console.WriteLine("Enter the file path to load activity statistics:");
    //         string filePath = Console.ReadLine();

    //         // Read the activity statistics from the file
    //         string activityStatistics = File.ReadAllText(filePath);

    //         // Process the activity statistics data
    //         // ...
    ...
    //     catch (Exception ex)
    //     {
    //         Console.WriteLine($"Error occurred while loading activity statistics: {ex.Message}");
    //     }
